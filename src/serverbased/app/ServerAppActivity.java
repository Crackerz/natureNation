    ...
    public void setWidgets()
    {
    	...
    	map.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) 
			{
				...
				// TODO Auto-generated method stub
				radiusData = l.result;
				Intent i = new Intent(ServerAppActivity.this, GeoLocations.class);
				i.putExtra("radiusData",radiusData);
				startActivity(i);
				}
				else
					Toast.makeText(ServerAppActivity.this, "Please wait for data to load", Toast.LENGTH_LONG).show();
